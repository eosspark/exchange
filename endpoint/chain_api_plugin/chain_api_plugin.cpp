...
void chain_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
      CHAIN_RO_CALL(get_info2, 200l),
      CHAIN_RO_CALL(abi_json_to_bin2, 200),
      CHAIN_RO_CALL(get_required_keys2, 200),
      CHAIN_RW_CALL_ASYNC(push_transaction2, chain_apis::read_write::push_transaction2_results, 202),
