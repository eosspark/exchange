...
public:
   ...
   get_info2_results get_info2(const get_info2_params&) const;
...
FC_REFLECT( eosio::chain_apis::read_only::abi_json_to_bin2_params, (code)(action)(args) )
FC_REFLECT( eosio::chain_apis::read_only::abi_json_to_bin_data, (binargs) )
FC_REFLECT( eosio::chain_apis::read_only::abi_json_to_bin2_result, (code)(message)(data) )
FC_REFLECT( eosio::chain_apis::read_only::get_required_keys2_params, (transaction)(available_keys) )
FC_REFLECT( eosio::chain_apis::read_only::get_required_keys_data, (required_keys) )
FC_REFLECT( eosio::chain_apis::read_only::get_required_keys2_result,(code)(message)(data))
FC_REFLECT(eosio::chain_apis::read_only::get_info_data,
(server_version)(chain_id)(head_block_num)(last_irreversible_block_num)(last_irreversible_block_id)(head_block_id)(head_block_time)(head_block_producer)(virtual_block_cpu_limit)(virtual_block_net_limit)(block_cpu_limit)(block_net_limit) )
FC_REFLECT( eosio::chain_apis::read_only::get_info2_results,(code)(message)(data))

FC_REFLECT( eosio::chain_apis::read_write::push_transaction_data, (transaction_id)(processed) )
FC_REFLECT( eosio::chain_apis::read_write::push_transaction2_results,(code)(message)(data))
